...
public class OfertaEspecialidad {
	
	@Override
	public String toString() {
		return "OfertaLaboral [id= " + id_avi 
				+ ", cargo =" + cargo_avi
				+ ", inicio =" + inicio_avi 
				+ ", fin =" + fin_avi
				+ ", descripcion =" + descripcion_avi
				+ ", jornada =" + jornadaLaboral_avi 
				+ ", disponibilidad =" + disponibilidad_avi
				+ ", requerimientos	=" + requerimientos_avi 
				+ ", beneficios	=" + beneficios_avi 
				+ ", sueldo	=" + sueldo_avi
	...
	public Double getSueldo_avi() {
		return sueldo_avi;
	}
	public void setSueldo_avi(Double sueldo_avi) {
		this.sueldo_avi = sueldo_avi;
	}
