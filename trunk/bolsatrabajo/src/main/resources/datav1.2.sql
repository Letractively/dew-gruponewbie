...
insert into tb_persona (id_per,email_per,password_per,titulo_per,resumen_per,disponibilidad_per,salario_per,nombreRazonSocial_per,apellidoPaterno_per,apellidoMaterno_per,direccion_per,numeroDocumento_per,sexo_per,fechaNacimiento_per,telefono_per,celular_per,id_tipper,id_tipusu,id_dis,id_tipdoc) values (8,'admin','admin','','Administrador del Sistema','',0.00,'','','','','','X','1940-03-04','','',1,3,'150101',1);
